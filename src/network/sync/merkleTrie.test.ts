...
describe('MerkleTrie', () => {
  ...
  test('getDivergencePrefix returns the prefix with the most common excluded hashes', async () => {
    const trie = await trieWithMessages([1665182332, 1665182343, 1665182345]);
    ...
    divergencePrefix = trie.getDivergencePrefix(prefixToTest, trie.getSnapshot('1665182343').excludedHashes);

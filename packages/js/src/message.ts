...
interface WrappedEd25519Message extends WrappedMessage {
  signatureScheme: flatbuffers.SignatureScheme.Ed25519;
}

export interface WrappedCastAdd extends WrappedEd25519Message {
  data: types.MessageData<types.CastAddBody, flatbuffers.MessageType.CastAdd>;
}

...
const SIGNER = "0x8ffd0c29933d17a94db69b69515703e9541f3c9fb93b7f7c88e36d1a8bc3ff3d";
// Fid owned by the custody address
const FID = 518236; // @mekboy // <REQUIRED>
...
(async () => {
  ...
  const reactionAdd = await makeReactionAdd(
    { type: ReactionType.DISLIKE, targetCastId: { fid: createdCast.data.fid, hash: createdCast.hash } },
    dataOptions,
    ed25519Signer,
  );
  otherMessages.push(reactionAdd);
